...
JustGage = function(config) {
  ...
  var node;
/*
  Blocco per stampare oggetto in input. Davide.
...
*/
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#fff"),

    // titleFontFamily : string
    // color of gauge title
    titleFontFamily: kvLookup('titleFontFamily', config, dataset, "Arial, sans-serif"),
    ...
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Arial, sans-serif"),
    ...
    // max : float
    // max value
    max: kvLookup('max', config, dataset, 200, 'float'),
    ...
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#191919FF"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#fff"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#fff"], 'array', ','),
    ...
    titleMinFontSize: kvLookup('titleMinFontSize', config, dataset, 16),
    ...
    minLabelMinFontSize: kvLookup('minLabelMinFontSize', config, dataset, 16),

    // maxLabelMinFontSize
    // absolute minimum font size for the maximum label
    maxLabelMinFontSize: kvLookup('maxLabelMinFontSize', config, dataset, 16),
  ...
  obj.originalValue = kvLookup('value', config, dataset, -1, 'string');
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH / 8) > obj.config.valueMinFontSize) ? (widgetH / 8) : obj.config.valueMinFontSize;
    valueX = dx + widgetW / 2;
  ...
  //DAVIDE
  obj.originalValue = obj.originalValue.toString();
  obj.originalValue = obj.originalValue.concat("%");
  //FINE DAVIDE
