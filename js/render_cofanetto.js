var render_cofanetto = (function() {
    
    if (!Detector.webgl) {
        Detector.addGetWebGLMessage();
    }

    var objPath = 'models/testa/';
    var objName = 'testabis_lp';
    var conainerId = 'render_cofanetto';
    ...
    function init_render() {
        ...
        mtlLoader.load(objName+'.mtl', function (materials) {
            ...
            /* VARIABLE */
            //materials.materials.mute_1.map.magFilter = THREE.NearestFilter;
            //materials.materials.mute_1.map.minFilter = THREE.LinearFilter;
    ...
    function render() {
		...
		var t=controls.getContaZoom();
			...
			var dpi=document.getElementById("dpi_5").offsetHeight;
			var prtOut = outputA*(2.54/dpi);
			prtOut = prtOut.toFixed(2);
			document.getElementById("myText9").innerHTML = prtOut +' cm';//a*0.02871;
			document.getElementById("myText10").innerHTML = objRealSizecm +' cm';//a*0.02871;
			//var slider = document.getElementById("myRange");
			//slider.value=prtOut*5000/objRealSizecm;
			//document.getElementById("g1").value=prtOut*200/objRealSizecm;
			valGage5=prtOut*100/objRealSizecm;
