var render_obj_herculaneum = (function() {
    ...
    function init_render(objNumber) {

        container = document.createElement('div');
        var d = document.getElementById('render_obj' + objNumber + '_herculaneum');
        ...
        mtlLoader.setBaseUrl(objPaths[objNumber]);
        mtlLoader.setPath(objPaths[objNumber]);
        mtlLoader.load(objNames[objNumber]+'.mtl', function (materials) {
            ...
            objLoader.setPath(objPaths[objNumber]);
            objLoader.load(objNames[objNumber]+'.obj', function (object) {
                scene.add(object);
				tempObject=object;
    ...
    function init(objNumber) {
        init_render(objNumber);
        //animate();        
    }
