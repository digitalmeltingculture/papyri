var render_ushabti1 = (function() {
    
    if (!Detector.webgl) {
        Detector.addGetWebGLMessage();
    }

    var objPath = 'models/studioscultore/';
    var objName = 'studioscultore_lp_0';
    var conainerId = 'render_ushabti1';
    ...
    function render() {
		...
		var t=controls.getContaZoom();
			...
			var dpi=document.getElementById("dpi_4").offsetHeight;
			var prtOut = outputA*(2.54/dpi);
			prtOut = prtOut.toFixed(2);
			document.getElementById("myText7").innerHTML = prtOut +' cm';//a*0.02871;
			document.getElementById("myText8").innerHTML = objRealSizecm +' cm';//a*0.02871;
			//var slider = document.getElementById("myRange");
			//slider.value=prtOut*5000/objRealSizecm;
			//document.getElementById("g1").value=prtOut*200/objRealSizecm;
			valGage4=prtOut*100/objRealSizecm;
