var render_ushabti2 = (function() {
    
    if (!Detector.webgl) {
        Detector.addGetWebGLMessage();
    }

    var objPath = 'models/paendua/';
    var objName = 'paendua_lpb';
    var conainerId = 'render_ushabti2';
    ...
    function render() {
		...
		var t=controls.getContaZoom();
			...
			var dpi=document.getElementById("dpi_3").offsetHeight;
			var prtOut = outputA*(2.54/dpi);
			prtOut = prtOut.toFixed(2);
			document.getElementById("myText5").innerHTML = prtOut +' cm';//a*0.02871;
			document.getElementById("myText6").innerHTML = objRealSizecm +' cm';//a*0.02871;
			//var slider = document.getElementById("myRange");
			//slider.value=prtOut*5000/objRealSizecm;
			//document.getElementById("g1").value=prtOut*200/objRealSizecm;
			valGage3=prtOut*100/objRealSizecm;
